...
var tbrow = '<tr><td>{0}</td><td>{1}</td><td>{2}</td><td><i title="删除" class="hand fa fa-times fa-1x" aria-hidden="true" onclick="removeExtension(\'{0}\')"></i>&nbsp;&nbsp<i id="{0}" title="运行/停止" class="hand fa" aria-hidden="true" onclick="handleExtension(\'{0}\')"></i>&nbsp;&nbsp<i title="修改配置" class="hand fa fa-pencil-square-o" aria-hidden="true" onclick="edit(\'{0}\')"></i></td></tr>'
...
$(document).ready(function () {
    $.ajax({
        ...
        $.each(JSON.parse(res), function (index, item) {
            ...
            $("#tb_exts tr:gt(0)").hover(function () {
                $(this).addClass("hover")
            }, function () {
                $(this).removeClass("hover")
            });
            $("#tb_exts i").hover(function () {
                $(this).addClass("back")
            }, function () {
